      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-begateway" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="begateway_encryptionkey" value="<?php echo $begateway_encryptionkey; ?>" placeholder="<?php echo $entry_encyptionkey; ?>" id="input-key" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="begateway_test_mode" id="input-test-mode" class="form-control">
                <?php $enabled_selected = '';
                      $disabled_selected = '';
                      if ($begateway_test_mode) {
                        $enabled_selected = 'selected';
                      } else {
                        $disabled_selected = 'selected';
                      }
                ?>
                <option value="1" <?php echo $enabled_selected; ?> ><?php echo $text_test_mode; ?></option>
                <option value="0" <?php echo $disabled_selected; ?> ><?php echo $text_live_mode; ?></option>
              </select>
            </div>
          </div>
